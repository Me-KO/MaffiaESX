...
function OpenArmoryMenu(station)
  ...
  if Config.EnableArmoryManagement then
    ...
    local elements = {
      ...
      {label = 'Neem Object',  value = 'get_stock'},
      {label = 'Stop object weg',  value = 'put_stock'}
    }
    ...
    function(data, menu)
      ...
      if data.current.value == 'citizen_interaction' then
        ...
        ESX.UI.Menu.Open(
          'default', GetCurrentResourceName(), 'citizen_interaction',
          {
            ...
            align    = 'top-left',
            elements = {
              {label = _U('id_kaart'),       value = 'identity_card'},
              {label = _U('fouilleer'),        value = 'body_search'},
              {label = _U('Boei'),    value = 'handcuff'},
              {label = _U('Neem mee'),      value = 'drag'},
              {label = _U('Zet_In_voertuig'),  value = 'put_in_vehicle'},
              {label = _U('Haal_uit_voertuig'), value = 'out_the_vehicle'},
            },
          },
      ...
      if data.current.value == 'vehicle_interaction' then
        ...
        ESX.UI.Menu.Open(
          ...
          {
            title    = _U('Voertuig_Interactie'),
            align    = 'top-left',
            elements = {
              {label = _U('Voertuig_Informatie'), value = 'vehicle_infos'},
              {label = _U('Breek_open'),    value = 'hijack_vehicle'},
            },
          },
          function(data2, menu2)
      ...
      if data.current.value == 'object_spawner' then
        ...
        ESX.UI.Menu.Open(
          'default', GetCurrentResourceName(), 'citizen_interaction',
          {
            ...
            align    = 'top-left',
            elements = {
              {label = _U('pion'),     value = 'prop_roadcone02a'},
              {label = _U('barricade'), value = 'prop_barrier_work06a'},
              {label = _U('spikestrips'),    value = 'p_ld_stinger_s'},
              {label = _U('doos'),   value = 'prop_boxpile_07d'},
              {label = _U('gelddoos'),   value = 'hei_prop_cash_crate_half_full'}
            },
          },
          function(data2, menu2)
...
function OpenBodySearchMenu(player)
  ...
  ESX.TriggerServerCallback('esx_mafiajob:getOtherPlayerData', function(data)
    ...
    table.insert(elements, {
      label          = _U('Pak_zwartgeld') .. blackMoney,
      value          = 'black_money',
    ...
    for i=1, #data.weapons, 1 do
      table.insert(elements, {
        label          = _U('confisqueer') .. ESX.GetWeaponLabel(data.weapons[i].name),
